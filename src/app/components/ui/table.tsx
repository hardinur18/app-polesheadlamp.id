...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "transition-colors data-[state=selected]:bg-indigo-50 dark:data-[state=selected]:bg-slate-900",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      // Changed text-muted-foreground to text-text-primary for "stronger" header
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      // Added text-text-secondary to make cells slightly lighter than header
